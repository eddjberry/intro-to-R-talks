...
df2 <- as_tibble(list(id = 1:60, year = year, memory =memory, attention = attention, attainment = attainment))
...
+ See the file intro-to-R.Rmd in the folder intro-to-R
    + There is also a knitted HTML version of the slides in that folder